...
District-level design specifications for all five MVP districts.

## Files

- [mvp-old-quarter.md](mvp-old-quarter.md) — Old Quarter: memory/archive district, primary MVP investigation space
- [mvp-lantern-ward.md](mvp-lantern-ward.md) — Lantern Ward: civic lantern administration, secondary MVP district
...
| District | Lantern | Stability | Faction Hold | Access Pattern |
|---|---|---|---|---|
| Old Quarter | dim | 0.47 | Memory Keepers dominant | restricted |
| Lantern Ward | bright | 0.71 | Council of Lights dominant | controlled |
